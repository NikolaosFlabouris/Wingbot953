...
export const franchiseQuestions = [
    {
        Question:
    ...
    },
    {
        ...
        Answers: QuizNaming.Games.HaloCE,
    },
    {
    ...
    },
    {
        ...
        Answers: QuizNaming.Games.Halo5,
    },
    {
        Question:
    ...
    {
        Question: "What year was Halo: Spartan Assault released?",
        Answers: ["2013"],
    },
    {
        Question:
    ...
    },
    {
        ...
        Answers: QuizNaming.Characters.SpartanDavis,
    },
    {
        Question:
            "Halo: Spartan Assault features two protagonists, Spartan Edward Davis and which other Spartan?",
        Answers: QuizNaming.Characters.SpartanPalmer,
    },
    {
        Question:
            'Complete this Halo: Spartan Assault quote (1 word): "Yeah! Nice work ____!"',
        Answers: ["dawg", "dawg!"],
    },
    {
        Question:
            "What is the name of the second isometric 'twin stick' shooter Halo game developed in collaboration with Vanguard Games?",
        Answers: QuizNaming.Games.HaloSpartanStrike,
    },
    {
        Question: "What year was Halo: Spartan Strike released?",
        Answers: ["2015"],
    },
    {
        Question:
        ...
        Answers: QuizNaming.Vehicles.Kestrel,
    },
    {
        Question:
            "What is the name of the Halo game that is a co-operative arcade shooter?",
        Answers: QuizNaming.Games.HaloFireteamRaven,
    },
    {
