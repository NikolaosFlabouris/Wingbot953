...
export const halo4Questions = [
    ...
    {
        Question:
            "MCC launched with a glitched that told the player to press which button at the end of Midnight?",
    ...
    {
        Question:
            "In Halo 4, what was the name of the highest Commendation rank?",
        Answers: ["Master"],
    },
    {
