...
export const halo4Questions = [
  ...
  },
  {
    ...
    Answers: QuizNaming.Weapons.GravityHammer,
  },
  {
    Question:
  ...
  {
    Question:
      "During the campaign, what is the first Armour Ability available to the player to use?",
  ...
  },
  {
    ...
    Answers: QuizNaming.Weapons.IncinerationCannon,
  },
  {
    Question:
  ...
  {
    Question: "What is the only Halo 4 mission without a terminal?",
    Answers: QuizNaming.Levels.H4.Dawn,
  },
  {
    Question:
  ...
  },
  {
    ...
    Answers: QuizNaming.Locations.Installation03,
  },
  {
  ...
  },
  {
    ...
    Answers: QuizNaming.Levels.H4.Midnight,
  },
  {
  ...
  {
    Question:
      "MCC launched with a glitch that told the player to press which button at the end of Midnight?",
  ...
  {
    Question:
      "Name a Fireteam that you meet (but do not play as) in the Spartan Ops campaign.",
    Answers: [
  ...
  },
  {
    ...
    Answers: QuizNaming.Numbers.Fifty,
  },
  {
    Question:
      "Which episode from Spartan Ops shares a name with a main mission from the Halo FPS series?",
    Answers: ["Exodus"],
  },
  {
    Question: "Who shot Halsey, causing the loss of her left arm?",
    Answers: QuizNaming.Characters.SpartanCommanderPalmer,
  },
  {
    Question:
      'Complete this quote (2 words): "Uh, I\'m sorry - did I miss orbiting a ______ _____ at some point?"',
    Answers: ["Forerunner planet"],
  },
  {
    Question:
      'Complete this quote (2 words): "So far, I\'ve pulled multiple strings referring to the big ones as _____ _____"',
  ...
  {
    Question:
      'Who says the following quote: "So fades the great harvest of my betrayal."',
    Answers: ["Didact", "Ur-Didact"],
  },
  {
    Question:
      'Who says the following quote: "Afraid we\'ll have to give you an IOU on that welcome home party."',
    Answers: QuizNaming.Characters.ThomasLasky,
  },
  {
    Question:
      'Who says the following quote: "Well. Someone\'s overcompensating."',
    Answers: QuizNaming.Characters.Cortana,
  },
  {
    Question:
      "In the original version of the game, how many Commendations were there?",
    Answers: QuizNaming.Numbers.OneHundredTwentyOne,
  },
  {
  ...
  },
  {
    ...
    Answers: ["SR130"].concat(QuizNaming.Numbers.OneHundredThirty),
  },
  {
  ...
  },
  {
    ...
    Answers: QuizNaming.Numbers.OneHundredSeventySix,
  },
  {
    Question:
      "What is the name of the Oddball-variant gametype that first appeared in Halo 4 DLC?",
    Answers: ["Ricochet"],
  },
  {
  ...
  {
    Question:
      "In Halo 4, the gametype typically known as 'Infection' is given what name?",
    Answers: ["Flood"],
  },
  {
    Question:
      'In Halo 4, what is the name of the FFA-variant gametype that declares the leading scorer the "king" until they are killed?',
    Answers: ["Regicide"],
  },
  {
    Question:
      "In Halo 4, what is the name of the 5v5 gametype that requires players to plant beacons to secure Slipspace crates?",
    Answers: ["Extraction"],
  },
  {
    Question:
      "In Halo 4, what is the name of the 6v6 gametype that requires players to capture and hold bases from the opposite team?",
    Answers: ["Dominion"],
  },
  {
    Question: "How many multiplayer maps are there in Halo 4?",
    Answers: QuizNaming.Numbers.TwentyFive,
  },
  {
    Question:
      "Which multiplayer map is the setting for the cutscene where Master Chief meets the Librarian?",
    Answers: ["Haven"],
  },
  {
    Question:
      "Halo 3's multiplayer map 'The Pit' was remade and given what name in Halo 4 Multiplayer?",
    Answers: ["Pitfall"],
  },
  {
    Question:
      "Halo 3's multiplayer map 'Valhalla' was remade and given what name in Halo 4 Multiplayer?",
    Answers: ["Ragnarok"],
  },
];
