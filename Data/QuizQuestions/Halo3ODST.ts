...
export const odstQuestions = [
  ...
  },
  {
    ...
    Answers: QuizNaming.Weapons.AssaultRifle,
  },
  {
  ...
  },
  {
    ...
    Answers: QuizNaming.Weapons.RocketLauncher,
  },
  {
    Question: "What is Romeo's signature weapon?",
    Answers: QuizNaming.Weapons.SniperRifle,
  },
  {
    Question: "What is Dare's signature weapon?",
    Answers: QuizNaming.Weapons.Automag,
  },
  {
  ...
  },
  {
    ...
    Answers: QuizNaming.Numbers.TwoHundredForty,
  },
  {
    Question: "An Automag with full ammo has how many bullets?",
    Answers: QuizNaming.Numbers.SeventyTwo,
  },
  {
  ...
  },
  {
    ...
    Answers: [
      "The Rookie",
      "The Rookie (Season 4, Episode 2) https://youtu.be/bHmRHWdnKP0",
    ],
  },
  {
  ...
  {
    Question:
      "The cutscene at the end of Uplift Reserve changes depending on whether the player is driving a Warthog, a Ghost, or which other vehicle?",
  ...
  },
  {
    ...
    Answers: QuizNaming.Numbers.TwentyNine,
  },
  {
    Question:
  ...
  {
    Question:
      "2 skulls were cut from the original release of Halo 3: ODST. One provided a 'directors style' commentary, what did the other skull do?",
    Answers: [
      "3rd person camera",
      "third person camera",
      "More info here: https://youtu.be/9InGqBDgff8",
    ],
  },
  {
    Question:
  ...
  {
    Question:
      "On the mission Coastal Highway, The Rookie, Buck, Dare and Virgil hold out for pickup in front of which facility?",
    Answers: [
  ...
  {
    Question:
      "On the mission Kikowani Station, on Legendary difficulty, on MCC, what character appears when triggering the sound cue?",
    Answers: ["Hamish Beamish", "Beamish"],
  },
  {
    Question: "Which campaign level has the most Hunter spawns?",
    Answers: QuizNaming.Levels.ODST.MombasaStreets,
  },
  {
  ...
  },
  {
    ...
    Answers: QuizNaming.Numbers.FourThousand,
  },
  {
    Question:
  ...
  },
  {
    ...
    Answers: QuizNaming.Characters.Mickey,
  },
  {
    Question:
  ...
  },
  {
    ...
    Answers: QuizNaming.Characters.Dutch,
  },
  {
    Question:
  ...
  },
  {
    ...
    Answers: QuizNaming.Characters.Romeo,
  },
  {
  ...
  },
  {
    ...
    Answers: QuizNaming.Characters.Dare,
  },
  {
    Question:
  ...
  {
    Question:
      'Complete this quote (1 word): "Careful. I think you just strained a ______."',
    Answers: ["metaphor"],
  },
  {
    Question:
      "Complete this quote (4 words): \"I'll draw the turret's fire, ___ ___ ___ ___\"",
    Answers: ["you kill the operator"],
  },
  {
    Question:
      'Complete this quote (3 words): "Gunny, I can fly a Pelican, ___ ___ ___?"',
  ...
  {
    Question:
      'Complete this quote (3 words): "No time to explain but do not, I repeat, do not ____ ____ ____"',
  ...
  {
    Question: "The Prepare to Drop cutscene occurs inside which UNSC ship?",
