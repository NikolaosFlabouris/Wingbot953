...
export const halo3Questions = [
  ...
  },
  {
    ...
    Answers: QuizNaming.Weapons.SpartanLaser,
  },
  {
    Question:
  ...
  },
  {
    ...
    Answers: QuizNaming.Characters.SergeantReynolds,
  },
  {
    Question:
  ...
  },
  {
    ...
    Answers: QuizNaming.Levels.H3.Tsavo,
  },
  {
  ...
  {
    Question:
      "What name was given to the internal Halo 3 build released to Microsoft employees in August 2007?",
    Answers: ["Halo 3 Epsilon", "Epsilon", "H3 Epsilon"],
  },
  {
    Question: "In which town does the mission The Storm take place?",
    Answers: ["Voi"],
  },
  {
    Question: "On which mission does the player defeat Cethegus?",
    Answers: QuizNaming.Levels.H3.Ark,
  },
  {
    Question: "The Microsoft Sam Easter Egg is found on which level?",
    Answers: QuizNaming.Levels.H3.Covie,
  },
  {
  ...
  {
    Question: "The Password-lacking Marine Easter Egg is found on which level?",
    Answers: QuizNaming.Levels.H3.Crows,
  },
  {
  ...
  },
  {
    ...
    Answers: QuizNaming.Numbers.Eleven,
  },
  {
    Question:
      "Which Covenant vehicle did not return to the series after its inclusion in Halo 3?",
    Answers: QuizNaming.Vehicles.Prowler,
  },
  {
    Question:
      "What was the name of the Halo 3 Multiplayer disc included alongside Halo 3: ODST?",
    Answers: ["Halo 3: Mythic", "Halo 3 Mythic", "H3 Mythic", "Halo 3:Mythic"],
  },
  {
    Question:
  ...
  },
  {
    ...
    Answers: QuizNaming.Numbers.FortyNine,
  },
  {
    Question:
      "The Vidmaster Challenge: Annual required all 4 co-op players to be in which vehicle at the end of the mission Halo?",
    Answers: QuizNaming.Vehicles.Ghost,
  },
  {
    Question:
      "Completing the Vidmaster Challenges unlocked which multiplayer armor piece?",
    Answers: ["Recon Helmet", "Recon", "Recon Armour", "Recon Armor"],
  },
  {
    Question:
      'The MCC achievement "Can\'t Keep Him Down" requires the player to fight alongside which character?',
    Answers: QuizNaming.Characters.ChipsDubbo,
  },
  {
    Question:
      'On what mission is the following quote said: "What\'s that sound?"',
    Answers: QuizNaming.Levels.H3.Storm,
  },
  {
    Question:
  ...
  {
    Question:
      'Who says the following quote: "First Squad, you\'re my scouts. Move out! Quiet as you can."',
    Answers: QuizNaming.Characters.SergeantJohnson,
  },
  {
    Question:
      'Who says the following quote: "Do you or do you not want to finish the fight?"',
    Answers: QuizNaming.Characters.SergeantJohnson,
  },
  {
    Question:
      "Who says the following quote: \"Marines? The Prophet of Truth doesn't know it yet, but he's about to get kicked right off his throne. We will take our city back. And drive our enemy into the grave they've been so happily digging. One final effort is all that remains.\"",
    Answers: QuizNaming.Characters.LordTerranceHood,
  },
  {
    Question:
      "Who says the following quote: \"Chief! Hood's ships are closing fast! Destroy that gun; we're out of time.\"",
    Answers: QuizNaming.Characters.MirandaKeyes,
  },
  {
  ...
  },
  {
    ...
    Answers: ["Shipmaster Rtas 'Vadum", "Shipmaster"].concat(
      QuizNaming.Characters.HalfJaw
    ),
  },
  {
    Question:
      'Who says the following quote: "You were weak. And gods must be strong."',
    Answers: QuizNaming.Characters.ProphetOfTruth,
  },
  {
    Question:
      'Who says the following quote: "Thought I\'d try shooting my way out - mix things up a little."',
    Answers: QuizNaming.Characters.MasterChief,
  },
  {
    Question:
      'Who says the following quote: "Protocol dictates action! I see now that helping you was wrong!"',
    Answers: QuizNaming.Characters.ThreeFourThreeGuiltySpark,
  },
  {
  ...
  {
    Question: 'Complete this quote (1 word): "A fresh _____! Must be close."',
    Answers: ["scent"],
  },
  {
    Question:
      "Complete this quote (2 words): \"There's something in the crater, Ma'am. Something beneath ___ ___.\"",
    Answers: ["the storm"],
  },
  {
    Question:
      'Complete this quote (2 words): "___ ___, my brothers! Only our enemies should fear this raging storm!"',
    Answers: ["Take heart", "They cough"],
  },
  {
    Question:
      'Complete this quote (3 words): "Wretched parasite! Rise up and I will kill you! ___ ___ ___!"',
  ...
  {
    Question:
      'Complete this quote (2 words): "I count ___ ___! Repeat: ___ ___!"',
    Answers: ["two Scarabs", "2 scarabs"],
  },
  {
    Question:
      'Complete this quote (3 words): "A collection of lies; that\'s all I am! Stolen ___ ___ ___!"',
  ...
  {
    Question:
      "In Halo 3 Multiplayer, what medal is awarded when the player wins by at least 20 kills?",
  ...
  {
    Question:
      "Halo 2's multiplayer map 'Zanzibar' was remade with what name in Halo 3 Multiplayer?",
    Answers: ["Last Resort"],
  },
];
