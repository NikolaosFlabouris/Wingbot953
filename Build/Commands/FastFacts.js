...
exports.SendDidYouKnowFact = exports.HandleFastFact = void 0;
const Utils_1 = require("./Utils");
const Twitch_1 = require("../Integrations/Twitch");
function HandleFastFact(originalMessage) {
    (0, Utils_1.SelectFromList)(fastFactList, originalMessage);
}
exports.HandleFastFact = HandleFastFact;
function SendDidYouKnowFact() {
    var index = (0, Utils_1.Between)(0, didYouKnowList.length - 1);
    (0, Twitch_1.SendMessage)("!didyouknow", "/me " + didYouKnowList[index]);
}
exports.SendDidYouKnowFact = SendDidYouKnowFact;
const fastFactList = [
...
const didYouKnowList = [
    ...
    "Did you know jumping up slopes saves ~1/60sec per jump!",
