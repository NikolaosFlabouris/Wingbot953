...
exports.HandleRandomNumberGeneration = exports.commandMap = void 0;
...
///
function HandleRandomNumberGeneration(msg) {
    ...
    if (originalMessage.split(" ").length >= 3) {
        ...
        if (lower != NaN && upper != NaN) {
            var num = (0, Utils_1.Between)(lower, upper).toString();
            if (num == "15") {
                num = `${num} moment`;
            }
            if (num == "953") {
            ...
            (0, Twitch_1.SendMessage)(command, `Your number is: ${num}.`);
            return;
        }
    }
    // Command used without correct arguments
    (0, Twitch_1.SendMessage)(command, "Usage: Randomly selects a number between the given numbers (inclusive): !random <number> <number>");
    return;
}
exports.HandleRandomNumberGeneration = HandleRandomNumberGeneration;
