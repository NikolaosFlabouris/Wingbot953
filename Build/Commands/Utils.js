...
exports.GenerateSeanMessage = exports.SelectFromList = exports.Between = exports.sleep = exports.SecondsToDuration = void 0;
const Twitch_1 = require("../Integrations/Twitch");
function SecondsToDuration(numIn) {
...
///
function SelectFromList(list, msg) {
    ...
    if (originalMessage.split(" ").length >= 2) {
        ...
        if (index == NaN) {
            (0, Twitch_1.SendMessage)(command, "Use a number following the command to specify which result should be given.");
            return;
        }
    }
    if (index < 0 || index >= list.length) {
        (0, Twitch_1.SendMessage)(command, `Value out of range: 1 to ${list.length}`);
        return;
    }
    (0, Twitch_1.SendMessage)(command, `[${index + 1}] ` + list[index]);
}
exports.SelectFromList = SelectFromList;
///
/// adiuahfiudhfusdhfisdfghoishoi
///
function GenerateSeanMessage() {
...
exports.GenerateSeanMessage = GenerateSeanMessage;
